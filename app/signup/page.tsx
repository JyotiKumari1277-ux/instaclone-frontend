        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <div className="relative">
            <input
              ...
              onChange={handleChange}
              required
              className="w-full bg-gray-100 dark:bg-gray-900 text-black dark:text-white border border-gray-300 dark:border-gray-700 rounded px-3 py-2 pr-10 text-sm focus:outline-none focus:border-gray-500"
            />
            <button
              type="button"
